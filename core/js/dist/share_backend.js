...
(function () {
  ...
  var ShareDialogView = OC.Backbone.View.extend({
    ...
    _getSuggestions: function _getSuggestions(searchTerm, perPage, model) {
      if (this._lastSuggestions && this._lastSuggestions.searchTerm === searchTerm && this._lastSuggestions.perPage === perPage && this._lastSuggestions.model === model) {
    ...
    autocompleteHandler: function autocompleteHandler(search, response) {
      ...
      this._getSuggestions(search.term.trim(), perPage, view.model).done(function (suggestions, exactMatches, moreResultsAvailable) {
    ...
    _confirmShare: function _confirmShare() {
      ...
      this._getSuggestions($shareWithField.val(), perPage, this.model, onlyExactMatches).done(function (suggestions, exactMatches) {
        if (suggestions.length === 0) {
          restoreUI();
  ...
  templates['sharedialoglinkshareview_popover_menu'] = template({
    ...
    "main": function main(container, depth0, helpers, partials, data) {
      ...
      return "<div class=\"popovermenu menu\">\n	<ul>\n		<li class=\"hidden linkTextMenu\">\n			<span class=\"menuitem icon-link-text\">\n				<input id=\"linkText-" + alias4((helper = (helper = helpers.cid || (depth0 != null ? depth0.cid : depth0)) != null ? helper : alias2, _typeof(helper) === alias3 ? helper.call(alias1, {
        ...
        "hash": {},
        "data": data
      }) : helper)) + "</label>\n				</span>\n			</li>\n" + ((stack1 = helpers["if"].call(alias1, depth0 != null ? depth0.showPasswordCheckBox : depth0, {
        "name": "if",
        "hash": {},
        "fn": container.program(7, data, 0),
        "inverse": container.noop,
        "data": data
      })) != null ? stack1 : "") + ((stack1 = helpers["if"].call(alias1, depth0 != null ? depth0.showPasswordByTalkCheckBox : depth0, {
        "name": "if",
        "hash": {},
